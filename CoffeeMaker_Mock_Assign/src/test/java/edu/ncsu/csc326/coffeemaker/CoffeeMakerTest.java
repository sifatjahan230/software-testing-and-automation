...
recipeBookStub = mock(RecipeBook.class);
when(coffeeMaker.addRecipe(recipe4)).thenReturn(true);
}

@Test
public void testMakeCoffee4() {
recipeBookStub = mock(RecipeBook.class);
when(coffeeMaker.deleteRecipe(1)).thenReturn(null);
}

@Test
public void testMakeCoffee5() {
recipeBookStub = mock(RecipeBook.class);
when(coffeeMaker.editRecipe(1,recipe4)).thenReturn(null);
}
